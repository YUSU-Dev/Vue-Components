        ...
        <div class="row activities-list">
            <div class="col">
                <div class="heading heading--primary heading--center pb-2">
                    <h2 class="heading__title"> <span>Clubs and Socs: A-Z</span></h2>
                </div>
            </div>
            <div class="col-lg-4 d-none d-lg-inline-flex">
                    <input class="nav-item w-100 float-right" type="text" aria-label="search for society/club"
                    ...
                    <div class="contacts-wrapper">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-12">
                                    <form>
                                        <h6 class="form__title">Filter</h6>
                                        <div class="row">
                                            <div class="col-12">
                                                <label>Category</label>
                                                <select class="form__field" v-model="SelectedCategory">
                                            ...
                                            <div class="col-12">
                                                <label>Search</label>
                                                <input aria-label="search for society/club" type="text" class="form__field" placeholder="Search..."
                                                       v-model="Search">
                                            </div>
                                        </div>
                                    </form>
            ...
            <div class="col-lg-12 d-none d-lg-block">
                <div class="nav-societies-type text-center">
                    <ul class="clubs-nav-block nav nav-tabs nav-justified u-nav-v2-1 u-nav-rounded-3 u-nav-primary g-mb-30"
                        data-btn-classes="btn btn-md btn-block u-btn-outline-primary g-mb-30" >
                        <li v-for="Parent in ActivityParents" @click.prevent="SelectedParent = Parent" @click.prevent="SelectedCategory = ''"
                        class="nav-item"><a v-bind:class="{'active':(SelectedParent === Parent)}" class="nav-link" :href="'/student-life/clubs-and-socs?category='+Parent"><span>{{ Parent }}</span></a></li>
                    </ul>
                    <ul class="nav nav-pills nav-fill g-mb-30">
                        ...
                        <li v-for="Category in FilteredSubCategories" @click.prevent="SelectedCategory = Category"
                            class="nav-item" v-if=""><a v-bind:class="{'active':(SelectedCategory === Category)}" class="nav-link" :href="'/student-life/clubs-and-socs?category='+Category"><span>{{ Category }}</span></a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-md-2 mx-2 my-2 activity-article d-block" v-for="Activity in FilteredActivities">
                    <div>
                        <a :href="'/activities/view/' + Activity.URL">
                            ...
                            <div v-if="Activity.Thumb" class="d-none d-md-block justify-content-center"
                             ...
                             v-bind:style="'background-image:url(' + Activity.Thumb + ');'"
                             alt="">
                            </div>
                            <div v-else class="d-none d-md-block justify-content-center"
                                ...
                                background-position: center; background-repeat: no-repeat; background-size: contain; cursor:pointer;"
                                 alt=""></div>
                            <div v-if="Activity.Thumb" class="d-md-none justify-content-center"
                                 style="height: 9em;overflow:hidden; background-position: center; background-repeat: no-repeat; background-size: contain; cursor:pointer;"
                             v-bind:style="'background-image:url(' + Activity.Thumb + ');'"
                             alt=""></div>
...
<!--                                             alt=""/></div>-->
                    ...
                    <div class="h6 g-color-grey g-mb-5 text-center align-bottom btn-block">
                        <p><a :href="'/activities/view/' + Activity.URL">{{ Activity.Name }}</a></p>
