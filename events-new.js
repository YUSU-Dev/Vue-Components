        ...
        <div class="container">
            ...
            <div class="row" v-for="event in Events">
                <article class="card my-2">
                    <div class="row">
                        <!-- Date -->
                        <div class="col-md-1 pr-0 ml-3 py-sm-3 align-items-center d-flex justify-content-center text-center">
                        ...
                        <!-- Article Image -->
                        <a :href=event.URL class="col-md-2 p-2 align-items-center d-flex justify-content-center text-center" style="max-height:500px; max-width:500px; height:auto; width:auto;">
...
var app = new Vue({
    ...
    methods: {
        getEvents: function() {
            let parameters = 'sortBy=start_date&onlyFuture=1';
